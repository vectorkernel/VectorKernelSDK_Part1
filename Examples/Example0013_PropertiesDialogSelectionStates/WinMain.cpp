...
{
    Win32Console::AttachDebugConsole("Example0013_PropertiesDialogSelectionStates - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0013_PropertiesDialogSelectionStatesWindow";
    windowParams.title = L"Example0013_PropertiesDialogSelectionStates";
