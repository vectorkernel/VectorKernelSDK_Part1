...
{
    Win32Console::AttachDebugConsole("Example0014_LayersDialogHotkey - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0014_LayersDialogHotkeyWindow";
    windowParams.title = L"Example0014_LayersDialogHotkey";
