...
{
    Win32Console::AttachDebugConsole("Example0012_EntityHighlightHover_HudDragon - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0012_EntityHighlightHover_HudDragonWindow";
    windowParams.title = L"Example0012_EntityHighlightHover_HudDragon";
