...
{
    Win32Console::AttachDebugConsole("Example0011_SnapGridInfiniteDragon_SnapGridOnly - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0011_SnapGridInfiniteDragon_SnapGridOnlyWindow";
    windowParams.title = L"Example0011_SnapGridInfiniteDragon_SnapGridOnly";
