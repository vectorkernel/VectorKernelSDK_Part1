...
{
    Win32Console::AttachDebugConsole("Example0016_ZoomCommandsHudJigs - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0016_ZoomCommandsHudJigsWindow";
    windowParams.title = L"Example0016_ZoomCommandsHudJigs";
