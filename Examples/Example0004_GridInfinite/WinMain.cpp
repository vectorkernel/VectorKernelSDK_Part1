...
{
    Win32Console::AttachDebugConsole("Example0004_GridInfinite - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0004_GridInfiniteWindow";
    windowParams.title = L"Example0004_GridInfinite";
