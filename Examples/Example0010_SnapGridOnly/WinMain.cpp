...
{
    Win32Console::AttachDebugConsole("Example0010_SnapGridOnly - Logs");

    gApplication = new Application();

    WindowCreateParams windowParams{};
    windowParams.className = L"Example0010_SnapGridOnlyWindow";
    windowParams.title = L"Example0010_SnapGridOnly";
